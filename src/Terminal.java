...
public class CLI {
	...
	private static String [] Description = {   // to be edit - not important anyway!
			"display current user directory.",
			"list each given file or directory name.",
			"changes the current directory to another one.",
			"copy two files content cp -r ~/folder1/. ~/new_folder1.", 
			"renames file SOURCE to DEST, or moves the SOURCE file (or files) to DIRECTORY.",
			"remove file.",
			"remove directory",
			"creates a directory with each given name.",
